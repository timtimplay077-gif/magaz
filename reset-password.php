...
<body>
    ...
    <div class="reset-pas block">
        <h2>Відновлення пароля</h2>
    </div>
    <div class="reset-box_password block">

        <div class="reset-box unselectable">

            <p>Введіть адресу електронної пошти вашого облікового запису. Натисніть кнопку "Продовжити" для
                отримання
                пароля
